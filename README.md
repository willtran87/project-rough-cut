...
- Input-responsive lateral camera movement that eases the world opposite a left/right strafe, adds a restrained counter-lean and near-ground speed accents, and drives the sky, horizon, course, obstacles, and foreground at distinct parallax strengths while the HUD stays fixed.
